...
public class Bozo {
	 ...
	 * @param args -
	 * @throws IOException - É lançada pela classe EntradaTeclado
	 */
	public static void main(String[] args) throws IOException {
		...
		for(int i = 0; i<10; i++) {
			...
			System.out.println("Digite os nímeros dos dados a serem rolados novamente (ex: 1 2 5) : ");
			while(true) {
				try {
					ler = EntradaTeclado.leString();
					dadosSorteados = dados.rolar(ler);
			...
			System.out.println("Selecione qual posição quer ocupar(AI: "+placar.getMelhorScore(dadosSorteados)+"): ");
